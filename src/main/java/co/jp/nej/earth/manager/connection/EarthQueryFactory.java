...
public class EarthQueryFactory extends SQLQueryFactory {
	 ...
	 */
	// TODO: Optimize later.
	public long insertTemplateData(MgrTemplate template, TemplateData templateData, String processId,
			String workItemId, Integer folderItemNo, Integer documentNo, Integer layerNo, int historyNo)
		...
		long count = insert(qTemplateData)
				.values(values)
				.execute();
		return count;
	}
