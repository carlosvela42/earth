...
public class DirectoryController extends BaseController {
    ...
    public String showList(Model model, HttpServletRequest request) throws EarthException {
        ...
        SessionUtil.clearAllOtherSearchCondition(session, Constant.ScreenKey.PROCESS_DIRECTORY);
        ClientSearchForm searchForm = (ClientSearchForm) SessionUtil.getSearchCondtionValue(session,
            Constant.ScreenKey.PROCESS_DIRECTORY);
    ...
    public String deleteList(DeleteProcessForm deleteForm, ClientSearchForm searchForm, HttpServletRequest request) {
        try {
            SessionUtil.setSearchCondtionValue(request.getSession(), Constant.ScreenKey.PROCESS_DIRECTORY, searchForm);
    ...
    public String showDetail(@ModelAttribute("dataDirectoryId") String dataDirectoryId, Model model,
            HttpServletRequest request, ClientSearchForm searchForm) throws EarthException {
        DirectoryForm directoryForm = new DirectoryForm();
        SessionUtil.setSearchCondtionValue(request.getSession(), Constant.ScreenKey.PROCESS_DIRECTORY, searchForm);
