...
<form action="${rc.getContextPath()}/schedule/insertOne" object="addScheduleForm" method="post" class="form-narrow
form-horizontal">
                    ...
                    <#if mgrTasks??>
                        <#list mgrTasks as mgrTask>
                            <#if mgrSchedule.taskId??>
                                <#assign selectedTask =(mgrSchedule.taskId==(mgrProcess.taskId?string("")))?then
                                ("selected","")>
                            </#if>
