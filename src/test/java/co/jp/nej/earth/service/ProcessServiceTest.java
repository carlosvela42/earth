...
public class ProcessServiceTest extends BaseTest {
    ...
    public void openProcess() throws Exception {
        ...
        this.excuteTest(workspaceId, fileInput, () -> {
            try {
                Assert.assertEquals(service.openProcess(httpSession, workspaceId, "1", "1", OpenProcessMode.EDIT),
                        true);
            } catch (Exception e) {
                throw e;
            }
    ...
    public void openProcess1() throws Exception {
        ...
        this.excuteTest(workspaceId, fileInput, () -> {
            try {
                Assert.assertEquals(service.openProcess(httpSession, workspaceId, "1", "1", OpenProcessMode.READ_ONLY),
                        true);
            } catch (Exception e) {
                throw e;
            }
    ...
    public void getProcess() throws Exception {
        ...
        this.excuteTest(workspaceId, fileInput, () -> {
            try {
                Assert.assertTrue(service.getProcess("003", 1) != null);
            } catch (Exception e) {
                throw e;
            }
        });
    ...
    public void updateProcess() throws Exception {
        ...
        ProcessMap datProcess = new ProcessMap();
        ...
        this.excuteTest(workspaceId, fileInput, () -> {
            try {
                Assert.assertEquals(service.updateProcess(session, "003", datProcess), false);
            } catch (Exception e) {
                throw e;
            }
        });
    ...
    public void closeAndSaveProcess() throws Exception {
        ...
        File fileInput = new File("src\\test\\resources\\processMap.xml");
        this.excuteTest(workspaceId, fileInput, () -> {
                Assert.assertEquals(service.closeAndSaveProcess(httpSession, workItem, workspaceId), true);
        });
    }
    ...
    public void closeAndSaveProcess1() throws Exception {
        ...
        this.excuteTest(workspaceId, fileInput, () -> {
            try {
                Assert.assertEquals(service.closeAndSaveProcess(httpSession, workItem, workspaceId), false);
            } catch (Exception e) {
                throw e;
            }
        });
    ...
    public void validateDeleteAction() {
        ...
        Assert.assertEquals(service.validateDeleteAction(form).isResult(), false);
    }

    @Test
    public void validateDeleteAction1() {
        DeleteProcessForm form = new DeleteProcessForm();
        List<Integer> processIds = new ArrayList<>();
        processIds.add(1);
        form.setProcessIds(processIds);
        form.setConfirmDelete(false);
        Assert.assertEquals(service.validateDeleteAction(form).isResult(), false);

    }

    @Test
    public void validateDeleteAction2() {
        DeleteProcessForm form = new DeleteProcessForm();
        List<Integer> processIds = new ArrayList<>();
        processIds.add(1);
        form.setProcessIds(processIds);
        form.setConfirmDelete(true);
        Assert.assertEquals(service.validateDeleteAction(form).isResult(), true);
    }
    ...
    public void insertOne() throws Exception {
        ...
        this.excuteTest(workspaceId, fileInput, () -> {
            try {
                Assert.assertEquals(service.insertOne(form), true);
            } catch (Exception e) {
                throw e;
            }
        });
    ...
    public void insertOne2() throws Exception {
        ...
        this.excuteTest(workspaceId, fileInput, () -> {
            try {
                Assert.assertEquals(service.insertOne(form), false);
            } catch (Exception e) {
                throw e;
            }
        });
    ...
    public void validateProcess() {
        ...
        Assert.assertEquals(service.validateProcess(form).isResult(), false);
    }
    ...
    public void validateProcess14() {
        ...
        form.setFileExtention("xml");
        form.setStrageDb(db);
        Assert.assertEquals(service.validateProcess(form).isResult(), true);
    }
