 ...
 *
 * import co.jp.nej.earth.BaseTest; import
 * co.jp.nej.earth.exception.EarthException; import
 * co.jp.nej.earth.service.WorkspaceService;
 *
 * public class ConnectionManagerTest extends BaseTest {
 *
 * @Autowired WorkspaceService workspaceService;
 *
 * @Test public void testGetAllConnections1() throws EarthException { //
 * Map<String, EarthQueryFactory> earthQueryFactories =
 * ConnectionManager.getEarthQueryFactory(workspaceId);
